...
Rmarkdown_template(title  = 'A Basic Example with mtcars', 
                   message = "It's helpful to automate custom reporting!", 
                   filename = 'A Basic Example') 
```

  * Now we can render the files to HTML
  
```{r Render_to_HTML}

Rmd_to_render <- c('A Basic Example')
